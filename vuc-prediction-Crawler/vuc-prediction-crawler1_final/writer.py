...
if __name__ == '__main__':
    # static data already written, no need to do again
    # try:
    #     print(given_data_writer('twitter_2014_7-12.json', "positive_tweets_2014", "neutral_tweets_2014", "negative_tweets_2014"
    #                         , get_boundaries('./geoserver-GetFeature.json')))
    #     print(given_data_writer('twitter_2015_1-6.json', "positive_tweets_2015", "neutral_tweets_2015", "negative_tweets_2015",
    #                          get_boundaries('./geoserver-GetFeature.json')))
    #     print(given_data_writer('twitter_2015_7-12.json', "positive_tweets_2015", "neutral_tweets_2015", "negative_tweets_2015"
    #                         , get_boundaries('./geoserver-GetFeature.json')))
    #     print(given_data_writer('twitter_2016-12.json', "positive_tweets_2016", "neutral_tweets_2016", "negative_tweets_2016"
    #                         , get_boundaries('./geoserver-GetFeature.json')))
    #     print(given_data_writer('twitter_2016_1-6.json', "positive_tweets_2016", "neutral_tweets_2016", "negative_tweets_2016"
    #                         , get_boundaries('./geoserver-GetFeature.json')))
    #     print(given_data_writer('twitter_2017-6.json', "positive_tweets_2017", "neutral_tweets_2017", "negative_tweets_2017"
    #                             , get_boundaries('./geoserver-GetFeature.json')))
    #     print(given_data_writer('twitter_2017-7.json', "positive_tweets_2017", "neutral_tweets_2017", "negative_tweets_2017"
    #                             , get_boundaries('./geoserver-GetFeature.json')))
    #     print(given_data_writer('twitter_2017-8.json', "positive_tweets_2017", "neutral_tweets_2017", "negative_tweets_2017"
    #                             , get_boundaries('./geoserver-GetFeature.json')))
    #     print(given_data_writer('twitter_2017-10.json', "positive_tweets_2017", "neutral_tweets_2017", "negative_tweets_2017"
    #                             , get_boundaries('./geoserver-GetFeature.json')))
    #     print(given_data_writer('twitter_2018-5.json', "positive_tweets_2018", "neutral_tweets_2018", "negative_tweets_2018"
    #                             , get_boundaries('./geoserver-GetFeature.json')))
    # except:
    #     print('no file')
