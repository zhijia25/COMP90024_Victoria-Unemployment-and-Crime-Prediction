...
def standard_search_crawler(max_tweets, area, tweet_file, user_list):
    auth = tweepy.AppAuthHandler("ujqGAvWCv9C14893iDGd8aUfb", "7VQIxQ8cQJ0mQQwre9nRG0uJ2LEBRlHmOcPUpjHPHO9DmsoDTE")
...
def stream_search_crawler(area):
    auth = tweepy.OAuthHandler("ujqGAvWCv9C14893iDGd8aUfb", "7VQIxQ8cQJ0mQQwre9nRG0uJ2LEBRlHmOcPUpjHPHO9DmsoDTE")
    auth.set_access_token("985020272716595200-uaGcLS4bODn5cP2MMl2NiRRWyKbBoyS",
                          "CWgEX0NxeIVMpM1syspP7ZzvQeMgdGncTekIkgiGvECn9")
...
def timeline_search_crawler(tweet_file, area):
    ...
    if not line:
        ...
        aut2 = twitter.Api("aMlAt9xTsFOxaD11InOfeo8NV", "37pfRhPJKSyZcCNPPJUfaoJxVhWobaqkSkR8oQobnkCQ5g3Et8",
                           "851934201506971648-H5d9b02jl5AdCG0eOm2EoZbXNq0xY4K",
                           "yKlL4K5PB4g9YDqWDzDAcu2AOzSDQNs3gZAYpdOUs3b6A")
